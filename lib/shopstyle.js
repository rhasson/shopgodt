...
var pid = require('../config/app_config.js').app_config.shopstyle.id;
...
Shopstyle.prototype.search = function(query, opt, cb) {
...
Shopstyle.prototype.getTrends = function(category, skipSample, cb) {
