            ...
            return {
                ...
                init: function () {
                    ...
                    if (!a.d.b || !a.d.h) a.f.close(a.a.msg.noPinIncompletePage);
                        ...
                        a.f.call(b, a.f.ping.check); //check if a site allows pinning
                        a.f.presentation();  //set up css rules
                        a.f.structure();  //build up the DOM
                        if (a.f.checkPage()) if (a.v.hazGoodUrl === true) {
                            a.f.behavior();  //setup event listener for clicks on thumbnails
